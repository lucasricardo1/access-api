# Java User Access API

A Spring Boot RESTful API for managing user access, profiles and authentication.

## 📋 Prerequisites
* JDK 25 or higher
* Maven 3.5.10 or higher

## Read Me First
The following was discovered as part of building this project:

* The original package name 'com.github.lucasricardo1.access-api' is invalid and this project uses 'com.github.lucasricardo1.access_api' instead.

## Default Spring Environment Guides
